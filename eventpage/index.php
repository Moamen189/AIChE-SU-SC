...
<link rel="shortcut icon" href="img/aiche.png" type="image/x-icon">
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav navbar-right">
					<li class="active"><a href="http://aichesusc.org/index.php">Home</a></li>
					<li><a href=http://aichesusc.org/index.php#about">About Us</a></li>
					<li><a href="http://aichesusc.org/eventpage/">Events</a></li>
					<li><a href="http://aichesusc.org/index.php#gallery">Gallery</a></li>
					<li><a href="http://aichesusc.org/aiche-blog-home-page/">Blog</a></li>
					<li><a href="http://aichesusc.org/index.php#contact">Contact Us</a></li>
					<!--<li class="dropdown">
		...
		<div id="myCarousel" class="carousel slide" data-ride="carousel"  data-interval="5000">
			...
			<div class="carousel-inner">
				<div class="item active">
					<img src="img/Untitled design (6).jpg" alt="Los Angeles" class="image-slider" width="100%">
					<div class="color-display"></div>
					<div class="carousel-caption">
						<h1 class="main-title">AIChE SUSC'9 Events
						</h1>
					</div>
				</div>
			</div>
	...
	<section class="wrapper"> 
		<div class="container">
			<div class="row">
				<!-- ========================================================= START PUT THE CODE OF THE PAGE HERE ===================================-->
    	...
    	<div class="post">
            ...
            <div class="post-s">
                <h2>
                    <a href=" https://aichesusc.org/eventpage/Alex/" target="_blank">Visit the event</a>
                </h2>
    	...
    	<div class="post">
            <img src="img/hysys.jpg" alt="">
            <div class="post-s">
                <h2>
                    <a href="https://fb.me/e/2RCswra86" target="_blank">Visit the event</a>
                </h2>
    	...
    	<div class="post">
            <img src="img/hazop.jpg" alt="">
            <div class="post-s">
                <h2>
                    <a href="https://facebook.com/events/291993056099701/?acontext=%7B%22event_action_history%22%3A[%7B%22extra_data%22%3A%22%22%2C%22mechanism%22%3A%22page_admin_consolidated_entry_buttons_row%22%2C%22surface%22%3A%22page%22%7D%2C%7B%22extra_data%22%3A%22%22%2C%22mechanism%22%3A%22surface%22%2C%22surface%22%3A%22create_dialog%22%7D]%2C%22ref_notif_type%22%3Anull%7D" target="_blank">Visit the event</a>
                </h2>
    ...
    <div class="event event1">
    	...
    	<div class="post">
            <img src="img/Srecruitment9.jpg" alt="">
            <div class="post-s">
                <h2>
                    <a href="https://aichesusc.org/eventpage/Recruitment%209/index.html" target="_blank">Visit the event</a>
                </h2>
    ...
    <div class="event event1">
    	...
    	<div class="post">
            ...
            <div class="post-s">
                <h2>
                    <a href="https://facebook.com/events/s/%D8%A7%D9%84%D8%AA%D8%B9%D8%B1%D9%8A%D9%81-%D8%A8%D8%A7%D9%82%D8%B3%D8%A7%D9%85-%D9%83%D9%84%D9%8A%D8%A9-%D8%A7%D9%84%D8%B9%D9%84%D9%88%D9%85-enl/385356173149821/" target="_blank">Visit the event</a>
                </h2>
   ...
   <div class="event event1">
    	...
    	<div class="post">
            ...
            <div class="post-s">
                <h2>
                    <a href="https://aichesusc.org/eventpage/Diploma%205/" target="_blank">Visit the event</a>
                </h2>
    ...
    <!--	<div class="post">-->
    <!--        <img src="img/69999079_2535769283111547_4266458819212607488_n.jpg" alt="">-->
    <!--        <div class="post-s">-->
    <!--            <h2>-->
    <!--                <a href="https://www.facebook.com/events/2754669311214705/" target="_blank">Visit the event</a>-->
    <!--            </h2>-->
    ...
    <!--        <div class="post-s">-->
    <!--            <h2>-->
    <!--                <a href="https://www.facebook.com/events/750073802118063/" target="_blank">Visit the event</a>-->
    <!--            </h2>-->
    ...
    <!--        <div class="post-s">-->
    <!--            <h2>-->
    <!--                <a href="https://www.facebook.com/events/453549765261123/" target="_blank">Visit the event</a>-->
    <!--            </h2>-->
    ...
    <!--        <div class="post-s">-->
    <!--            <h2>-->
    <!--                <a href="https://www.facebook.com/events/780676559055278/" target="_blank">Visit the event</a>-->
    <!--            </h2>-->
    ...
    <!--        <div class="post-s">-->
    <!--            <h2>-->
    <!--                <a href="https://www.facebook.com/events/1065125887012259/" target="_blank">Visit the event</a>-->
    <!--            </h2>-->
    ...
    <!--</div> 	-->
	   		...
	   		<!-- =========================================================  END PUT THE CODE OF THE PAGE HERE ===================================-->
			</div>
		</div>
	</section>
	<!-- ====================================== START FOOTER ======================================== -->
