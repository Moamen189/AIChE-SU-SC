...
<meta name="viewport" content="width=device-width,initial-scale=1" content="distillation">
	<title>research-paper-exposition</title>
		...
		<div id="myCarousel" class="carousel slide" data-ride="carousel"  data-interval="5000">
			...
			<div class="carousel-inner">
				<div class="item active">
					<img src="img/Galaxy Twitch Banner.png" alt="Los Angeles" class="image-slider" width="100%">
					<div class="color-display"></div>
					<div class="carousel-caption">
						<h1 class="main-title">Research Paper Exposition</h1>
...
<input type="text" name="student_name" id="name" required="required" placeholder="Please Enter Your Name"/><br /><br />

<label>Faculty:</label>
<input type="text" name="Faculty" id="Faculty" required="required" placeholder="Please Enter your Faculty"/><br /><br /><br/>

<label>Departement:</label>
<input type="text" name="departement" id="Departement" required="required" placeholder="Please Enter your Departement"/><br /><br /><br/>



<label>Academic Year:</label><br/>
<input type="radio" name="ac_yr"  value="Prep" id="radio" checked/>Prep<br/> 
<input type="radio" name="ac_yr"  value="First" id="radio" />First<br/>
<input type="radio" name="ac_yr"  value="Second" id="radio" />Second<br/>
<input type="radio" name="ac_yr"  value="Third" id="radio" />Third<br/>
<input type="radio" name="ac_yr"  value="Fourth" id="radio" />Fourth<br/>
<br/>


<label>Phone Number:</label>
<input type="tel" name="phone_number" id="Phone" required="required" placeholder="Please Enter Your Phone Number"/><br/><br />
...
$sql = "INSERT INTO researchpaper(student_name,Faculty,departement,ac_yr,phone_number,message)
...
if ($dbh->query($sql)) {
echo "<script type= 'text/javascript'>alert('Your information is recorded AIChE Suez wish you a lucky chance');</script>";
}
else{
